        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-foreground mb-4">
              What We <span className="text-neon-cyan neon-glow">Deliver</span>
            </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            ...
            <Card className="border-neon-cyan border-opacity-30 bg-card/50 backdrop-blur">
              <CardContent className="p-8">
                <h3 className="text-2xl font-bold text-neon-cyan neon-glow mb-6 text-center">
                  Proven Results
                </h3>
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div className="text-center">
                    ...
                    <div className="text-2xl font-bold text-neon-green neon-glow mb-1">340%</div>
                    <div className="text-sm text-muted-foreground">Lead Increase</div>
                  </div>
                  <div className="text-center">
                    <Users className="w-8 h-8 text-neon-pink mx-auto mb-2" />
                    <div className="text-2xl font-bold text-neon-pink neon-glow mb-1">£480K</div>
                    <div className="text-sm text-muted-foreground">ARR Growth</div>
                  </div>
                  <div className="text-center">
                    <Target className="w-8 h-8 text-terminal-amber mx-auto mb-2" />
                    <div className="text-2xl font-bold text-terminal-amber neon-glow mb-1">24.3%</div>
                    <div className="text-sm text-muted-foreground">Conversion Rate</div>
                  </div>
                  <div className="text-center">
                    <Zap className="w-8 h-8 text-neon-cyan mx-auto mb-2" />
                    <div className="text-2xl font-bold text-neon-cyan neon-glow mb-1">80%</div>
                    <div className="text-sm text-muted-foreground">Time Saved</div>
                  </div>
                </div>

                <div className="mt-6 p-4 bg-retro-dark rounded-lg">
                  ...
                  <div className="text-retro-light text-sm">
                    Average client sees <span className="text-neon-cyan">3.4x ROI</span> within 6 months
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              {[
                ...
                <div key={index} className="text-center">
                  <div className="w-16 h-16 mx-auto mb-4 bg-neon-cyan/10 border border-neon-cyan/30 rounded-full flex items-center justify-center text-2xl">
                    {item.icon}
                  </div>
                ...
                <Card key={testimonial.id} className="border-neon-cyan border-opacity-30 bg-card/50 backdrop-blur">
                  <CardContent className="p-8">
                    ...
                    <div className="flex items-center">
                      ...
                      <div>
                        <div className="font-semibold text-neon-cyan">{testimonial.name}</div>
