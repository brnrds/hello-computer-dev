...
export default function Footer() {
  const navigation = {
    services: [
      { name: "AI Growth Marketing", href: "/services/ai-growth" },
  ...
  return (
    <footer className="bg-retro-dark text-retro-light relative">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/* Services */}
          <div>
            <h3 className="text-neon-green terminal-text font-semibold mb-4">
              Services
            </h3>
